...
public class ProposalResourceIntTest {
    ...
    private static final Integer DEFAULT_FREELANCER_GRADE = 1;
    private static final Integer UPDATED_FREELANCER_GRADE = 2;

    private static final String DEFAULT_FREELANCER_COMMENT = "AAAAAAAAAA";
    private static final String UPDATED_FREELANCER_COMMENT = "BBBBBBBBBB";
    ...
    public static Proposal createEntity(EntityManager em) {
        Proposal proposal = new Proposal()
            ...
            .freelancerGrade(DEFAULT_FREELANCER_GRADE)
            .freelancerComment(DEFAULT_FREELANCER_COMMENT);
        return proposal;
    }
    ...
    public void createProposal() throws Exception {
        ...
        assertThat(testProposal.getFreelancerGrade()).isEqualTo(DEFAULT_FREELANCER_GRADE);
        assertThat(testProposal.getFreelancerComment()).isEqualTo(DEFAULT_FREELANCER_COMMENT);
    ...
    public void getAllProposals() throws Exception {
        ...
        restProposalMockMvc.perform(get("/api/proposals?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].freelancerGrade").value(hasItem(DEFAULT_FREELANCER_GRADE)))
            .andExpect(jsonPath("$.[*].freelancerComment").value(hasItem(DEFAULT_FREELANCER_COMMENT.toString())));
    }
    ...
    public void getProposal() throws Exception {
        ...
        restProposalMockMvc.perform(get("/api/proposals/{id}", proposal.getId()))
            ...
            .andExpect(jsonPath("$.freelancerGrade").value(DEFAULT_FREELANCER_GRADE))
            .andExpect(jsonPath("$.freelancerComment").value(DEFAULT_FREELANCER_COMMENT.toString()));
    }
    ...
    public void updateProposal() throws Exception {
        ...
        updatedProposal
            ...
            .freelancerGrade(UPDATED_FREELANCER_GRADE)
            .freelancerComment(UPDATED_FREELANCER_COMMENT);
        ...
        assertThat(testProposal.getFreelancerGrade()).isEqualTo(UPDATED_FREELANCER_GRADE);
        assertThat(testProposal.getFreelancerComment()).isEqualTo(UPDATED_FREELANCER_COMMENT);
