    ...
    open(component: Component, id?: number | any): NgbModalRef {
        ...
        if (id) {
            this.contractService.find(id).subscribe((contract) => {
                contract.startTime = this.datePipe
                    .transform(contract.startTime, 'yyyy-MM-ddThh:mm');
                contract.endTime = this.datePipe
                    .transform(contract.endTime, 'yyyy-MM-ddThh:mm');
