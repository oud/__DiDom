...
public class PaymentType implements Serializable {
    ...
    public PaymentType contracts(Set<Contract> contracts) {
        this.contracts = contracts;
        return this;
    }

    public PaymentType addContract(Contract contract) {
        this.contracts.add(contract);
        contract.setPaymentType(this);
        return this;
    }

    public PaymentType removeContract(Contract contract) {
